...
make.parameters.est.table(base.model.5abcd,
  caption = paste0("Valeurs a posteriori (2,5\\textsuperscript{e} centile, médiane et ",
    "97,5 \\textsuperscript{e} centile) et estimations du mode de distribution a posteriori ",
    "pour les paramètres clés du scénario de référence de la zone 5ABCD. $R_0$ est en milliers de poissons. $\\hat{R}$ représente la statistique de réduction d’échelle potentielle et $n_\\mathrm{eff}$ correspond au nombre réel de tirages effectués lors de la simulation (voir le corps du texte). ", q.5abcd.desc.fr),
  omit_pars = pars_est_omit, french=french)
```
