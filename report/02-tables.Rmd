...
make.ref.points.table(c(base.model.3cd,
                        ...
                        caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                                         ...
                                         "Biomass is in tonnes. All values are rounded. Ratios were calculated using full posterior distributions and cannot be calculated directly from the table."))
```
