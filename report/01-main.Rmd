...
This proportion was used to extrapolate from the catch at September 30, 2020 to a total estimated catch for the 2020 fishing year (Tables \@ref(tab:tab-catch-3cd) and \@ref(tab:tab-catch-5abcd)). In Area 3CD, the average proportion was 67.4%. In area 5ABCD, the average proportion was 87.8%.
<!-- TODO SA: consider whether this makes sense given COVID, or at least comment on -->
<!-- RF: For 3CD, the proportions taken by Sep 30 in 2017, 2018 and 2019 were different from each other (86%, 46% and 71%), probably because of the anomalously low catches in 2018 and 2019, so I don't know if we are dealing with typical fishing anyway. I think we just need to watch it -->
...
This is a notable decrease in estimated biomass ($B_{2021}/\textrm{LRP}$ = 1.62) compared to the 2018 assessment ($B_{2019}/\textrm{LRP}$ = 2.00) [@dfo2019; their Table 16 and Figure 3b].
