...
Decision tables were constructed for each area using the unweighted combined posterior samples [see @forrest2020].

### Area 3CD

For illustration, the combined average posterior biomass with a one year projection under four alternative catch levels is shown in Figure \@ref(fig:fig-model-average-biomass-3cd-proj).
