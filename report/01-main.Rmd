...
Combined average posterior biomass for all seven models is shown in Figure \@ref(fig:fig-model-average-biomass-3cd).
...
Combined average posterior results from all models indicate that the stock in 2020 was just above the LRP (Figure \@ref(fig:fig-model-average-f-3cd)).
This is a notable decrease in estimated stock status ($B_{2021}/\textrm{LRP}$ = 1.63) compared to the 2018 assessment ($B_{2019}/\textrm{LRP}$ = 2.07) [@dfo2019; their Table 1 and Figure 3b].
...
For all sensitivity cases, recent estimates of fishing mortality were well below the median LRR (Figure \@ref(fig:fig-model-average-f-3cd)).  
...
At the beginning of the 2021 fishing year, under the assumed 2020 catch level, median biomass is projected to be 19,556 t.
Median fishing mortality at the end of the 2020 fishing year is projected to be 3%.
The median estimated LRP and USR are estimated to be 9,785 t and 33,328 t, respectively.
The median estimated LRR is estimated to be 0.15 *y*^-1^.
Median biomass in 2021 relative to the LRP and USR are estimated to be 2.00 and 0.59, respectively.
Median fishing mortality relative to the LRR is estimated to be 0.18 *y*^-1^.
...
For all sensitivity cases, recent estimates of fishing mortality were well below the median LRR (Figure \@ref(fig:fig-model-average-f-5abcd))
