...
Notably, the median estimated value of natural mortality, $M$, was 0.451 *y*^-1^ (0.413--0.492 *y*^-1^) in the current assessment (Table \@ref(tab:tab-param-est-table-3cd)), compared to 0.424 *y*^-1^ (0.388--0.462 *y*^-1^) in 2018 [@forrest2020].
...
The median posterior estimate of $M$ was slightly lower in the current assessment, at 0.308 *y*^-1 (0.278--0.338 *y*^-1^), compared to 0.312 *y*^-1^ (0.280--0.347 *y*^-1^) in the 2018 assessment [@forrest2020].
