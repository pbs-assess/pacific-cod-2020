...
Current estimates of reference points and stock status conditioned on the 2020 catch levels are provided in Table \@ref(tab:tab-ref-points-table-avg-3cd).
At the beginning of the 2021 fishing year, **XXX**
...
Combined average posterior fishing mortality indicates that current fishing mortality is very low and well below the LRR.

### Area 5ABCD

Current estimates of reference points and stock status conditioned on the 2020 catch levels are provided in Table \@ref(tab:tab-ref-points-table-avg-5abcd).
At the beginning of the 2021 fishing year, **XXX**
...
Combined average posterior fishing mortality indicates that current fishing mortality is low and well below the LRR.
...
For each performance measure, under each alternative 2021 catch level, vectors of 1,000 burned-in posterior samples from each of the seven models were combined into a single vector of 7,000 samples. Probabilities of performance measures were then calculated from the combined samples.
...
For illustration, recent average biomass from the seven averaged models with a one year projection under four alternative catch levels is shown in Figure \@ref(fig:fig-model-average-biomass-5abcd-proj).
