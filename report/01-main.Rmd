...
2. Survey indices of abundance Figure \@ref(fig:surv-canadian)), where the 3CD model was fit to the WCVI Synoptic Survey and the NMFS triennial survey (Figure \@ref(fig:tri-fig9), Vancouver Canadian series). Detailed methods in Appendix A of @forrest2020.; 
