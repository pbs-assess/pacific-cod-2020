...
We recommend surveying Area 3CD as soon as it is feasible to do so, then updating this advice.
Further analysis of recent survey data including spatial and depth distribution of the stock and analysis of biological data, such as condition of the fish (length-weight data) and spatial distribution of length data could also provide insights into possible causes of the apparent rapid decline in abundance since 2018.
