...
Key characteristics of the models are provided in Tables \@ref(tab-param-table-3cd) and \@ref(tab-param-table-5abcd).
...
This suggests that the model is explaining the decreased biomass by estimating higher natural mortality, although there was considerable overlap between the current and 2018 posterior distributions.
