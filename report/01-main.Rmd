...
*TODO: add data plots -- put in appendix*
...
2. Survey indices of abundance Figure \@ref(fig:surv-canadian)). The 3CD model was fit to the WCVI Synoptic Survey and the NMFS triennial survey (Figure \@ref(fig:tri-fig9), Vancouver Canadian series). The 5ABCD model was fit to the Hecate Strait Synoptic Survey, the Queen Charlotte Sound Synoptic Survey and the Hecate Strait Multispecies Assemblage Survey. Detailed methods in Appendix A of @forrest2020.; 

3. Historical (1956-1995) and modern (1996+) commercial CPUE indices (Figure \@ref(fig:cpue-int-test-plot)). Detailed methods in Appendix B of @forrest2020.; and

4. Mean weight of Pacific Cod in the commercial bottom trawl fishery. Detailed methods in Appendix C of @forrest2020.
