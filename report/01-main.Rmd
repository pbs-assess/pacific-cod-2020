...
The last assessment for Pacific Cod (*Gadus macrocephalus*) in British Columbia (BC) was done in 2018 [@forrest2020; @dfo2019].
...
This Science Response reports results from the Science Response Process of November 2020 on the status of Pacific Cod for Hecate Strait and Queen Charlotte Sound (Area 5ABCD), and West Coast Vancouver Island (Area 3CD) in 2020.
...
Currently, the majority of the BC Pacific Cod catch is taken Area 5CD.
...
Since 1996, the proportions of estimated discards have been considerably higher than in years before at-sea observers (Tables \@ref(tab:tab-catch-3cd) and \@ref(tab:tab-catch-5abcd)), suggesting that pre-1996 values are underestimates. 
...
The range of the posterior estimate of $M$ was was nearly identical in the current assessment, at 0.308 *y*^-1^ (0.279--0.343 *y*^-1^), compared to 0.312 *y*^-1^ (0.280--0.347 *y*^-1^) in the 2018 assessment [@forrest2020].
...
The Regional Peer Review (RPR) meeting held in October 2018 reviewed the Reference Case model and the suite of sensitivity runs described above, and concluded that no one model adequately represented the uncertainty associated with these stock assessments.
...
Combined average posterior biomass and fishing mortality from the seven averaged models are shown in Figures \@ref(fig:fig-model-average-biomass-3cd) and \@ref(fig:fig-model-average-f-3cd).
...
Combined average posterior biomass and fishing mortality from the seven averaged models are shown in Figures \@ref(fig:fig-model-average-biomass-5abcd) and \@ref(fig:fig-model-average-f-5abcd).
...
We recommend surveying this area as soon as it is feasible to do so, and updating this advice when the data are available.
