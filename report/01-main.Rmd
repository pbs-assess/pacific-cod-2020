...
*TODO: add note on discards. See text for Sc 8 of @forrest2020*
...
Details are provided in Section \@ref(sec:model-scenarios).
...
## Model scenarios {#sec:model-scenarios}
...
Decision tables were constructed for each area using the unweighted combined posterior samples from a set of six sensitivity cases, plus the reference case (the "model-averaged" set), see Section \@ref(model-scenarios). 
