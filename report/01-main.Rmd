...
Here we present results from the two reference case models, to demonstrate model performance and to provide comparison with the 2018 stock assessment.
Advice, presented in the next section, is based on results averaged across all seven models in each area.
...
The 2022 biomass is projected to be in the Cautious Zone
(below the USR) with greater than 98%--99% probability under all 2021 catch scenarios tested, including zero catch.
...
1. The impact of uncertainty in the magnitude of pre-1996 discarding and foreign catches. Underestimation of historicals could lead to an underestimation of stock productivity;
...
We recommend surveying this area as soon as it is feasible to do so, then updating this advice when the data are available.
