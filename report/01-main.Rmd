...
The current assessment model is a delay-difference models [@deriso1980], fit to survey indices, commercial catch-per-unit-effort (CPUE), commercial catch data and commercial annual mean weights [@forrest2015; @forrest2020].
...
Model fits to the catch, indices and mean weight data are shown in Figures \@ref(fig:fig-base-catch-fit-3cd), \@ref(fig:fig-base-index-fits-3cd) and \@ref(fig:fig-base-mean-weight-3cd), respectively.
