...
The last assessment for Pacific Cod (*Gadus macrocephalus*) in British Columbia (BC) was done in 2018, providing catch advice for 2019 [@forrest2020; @dfo2019].
...
This Science Response reports results from the Science Response Process of October 2020 on the status of Pacific Cod for Hecate Strait and Queen Charlotte Sound (Area 5ABCD), and West Coast Vancouver Island (Area 3CD) in 2020.
...
This study focuses on the stocks in Queen Charlotte Sound combined with Hecate Strait (5ABCD), and West Coast Vancouver Island (3CD) (Figure \@ref(fig:fig-map)).

This assessment update provides science advice for combined areas 5AB and 5CD in a single stock assessment. The choice to combine the areas was made during the 2018 assessment [@dfo2019], mainly due to poor model diagnostics and the lack of historical fishery-independent indices of abundance for the Area 5AB model in the 2013 assessment [@forrest2015].
...
Prior to the introduction of at-sea observer coverage in 1996, estimates of at-sea releases (discards) for the period 1956--1995 were obtained from fishing logbooks in the absence of at-sea observers.
These estimates are therefore considered an underestimate of the actual releases (Tables \@ref(tab:tab-catch-5abcd) and \@ref(tab:tab-catch-3cd)), and are a major source of uncertainty in this assessment.
Estimates in years following the introduction of 100% at-sea observer coverage in 1996 can be considered to be  accurate.
Since 1996, the proportions of estimated discards have been considerably higher than in years before at-sea observers (Tables \@ref(tab:tab-catch-5abcd) and \@ref(tab:tab-catch-3cd)). Pacific Cod can be legally discarded by trawlers in BC.
However, on-board observers first estimate the quantity being discarded.
...
Values are provided in Table \@ref(tab:surv-canadian-table) and Figure \@ref(fig:surv-canadian).

Abundance in Area 3CD (Figure \@ref(fig:fig-map)) is indexed by the West Coast Vancouver Island Synoptic Survey.
...
Abundance in Area 5AB (Figure \@ref(fig:fig-map)) is indexed by the Queen Charlotte Sound Synoptic Survey.
The survey was first conducted in 2003 and 2004, and then in odd years since 2005.
Abundance in Area 5CD (Figure \@ref(fig:fig-map)) was indexed by the Hecate Strait Multispecies Assemblage Survey in 1984, 1987, 1989, 1991, 1993, 1995, 1996, 1998, 2000, 2002, and 2003.
...
In the absence of available commercial biological samples for 2020, we assumed the same annual mean weight in 2020 as for 2019.
...
The USR and LRP define the threshold of three biomass-based stock status zones defined under the PA Policy [@dfo2009]: Critical Zone (below the $\textrm{LRP}$); Cautious Zone (above the $\textrm{LRP}$ and below the $\textrm{USR}$); and Healthy Zone (above the $\textrm{USR}$).
...
The same model scenarios as those agreed upon at the Regional Peer Review for the 2018 assessment [@dfo2019] were used here for model-averaging (updated with catch data to 2020, and index data to 2019 where available).
...
The model followed the trends of the two fishery-independent indices (Figure \@ref(fig:fig-base-index-fits-3cd) a and d), but did not closely fit the 2012, 2014 and 2016 data points in WCVI Synoptic survey (Figure \@ref(fig:fig-base-index-fits-3cd)a).
...
Notably, the median estimated value of natural mortality, $M$, was 0.449 *y*^-1^ (0.412--0.489 *y*^-1^) in the current assessment (Table \@ref(tab:tab-param-est-table-3cd)), compared to 0.424 *y*^-1^ (0.388--0.462 *y*^-1^) in 2018 [@forrest2020].
Values in parentheses here and elsewhere refer to lower and upper bounds of the 95% credible interval. 
This result suggests that the model is explaining the decreased biomass by estimating higher natural mortality, although there was considerable overlap between the current and 2018 credible intervals.
...
The median posterior estimate of $M$ was slightly lower in the current assessment, at 0.308 *y*^-1 (0.279--0.343 *y*^-1^), compared to 0.312 *y*^-1^ (0.280--0.347 *y*^-1^) in the 2018 assessment [@forrest2020].
...
At the beginning of the 2021 fishing year, under the assumed 2020 catch level, median biomass is projected to be 14,099 t (6,008--47920 t).
Median fishing mortality at the end of the 2020 fishing year is projected to be 0.006 *y*^-1^ (0.002--0.015 *y*^-1^).
The median estimated LRP and USR are estimated to be 8,603 t (3,134--28,435 t) and 28,077 t (10,990--85,585 t), respectively.
The median estimated LRR is estimated to be 0.065 *y*^-1^ (0.021--0.198 *y*^-1^).
Median biomass in 2021 relative to the LRP and USR are estimated to be 1.639 (1.917--1.685) and 0.502 (0.547--0.560), respectively.
Median fishing mortality relative to the LRR is estimated to be 0.086 (0.077--0.074).

Combined average posterior biomass and fishing mortality from the seven averaged models is shown in Figures \@ref(fig:fig-model-average-biomass-3cd) and \@ref(fig:fig-model-average-f-3cd).
The estimated biomass range from the seven models was very broad.
...
This is a notable decrease in estimated stock status (median $B_{2021}/\textrm{LRP}$ = 1.639) compared to the 2018 assessment, where median $B_{2019}/\textrm{LRP}$ was 2.07 (2.48--2.16)) [@dfo2019].

The estimated fishing mortality range from the seven models was also broad (Figure \@ref(fig:fig-model-average-f-3cd)), reflecting the broad range of biomass estimates.
...
At the beginning of the 2021 fishing year, under the assumed 2020 catch level, median biomass is projected to be 19,634 t (11318--40603 t).
Median fishing mortality at the end of the 2020 fishing year is projected to be 0.027 *y*^1^ (0.013--0.049 *y*^1^).
The median estimated LRP and USR are estimated to be 9,814 t (5,662--20,881 t) and 33,448 t (20,095--60,089 t), respectively.
The median estimated LRR is estimated to be 0.152 *y*^-1^ (0.082--0.293 *y*^1^).
Median biomass in 2021 relative to the LRP and USR are estimated to be 2.001 (1.999--1.945) and 0.587 (0.536--0.676), respectively.
Median fishing mortality relative to the LRR is estimated to be 0.177 *y*^-1^ (0.154--0.166).

Combined average posterior biomass and fishing mortality from the seven averaged models is shown in Figures \@ref(fig:fig-model-average-biomass-5abcd) and \@ref(fig:fig-model-average-f-5abcd).

As for Area 3CD, the estimated biomass range from the seven models was very broad.
...
The estimated fishing mortality range from the seven models was also broad (Figure \@ref(fig:fig-model-average-f-3cd)), reflecting the range of biomass estimates.
...
Decision tables were constructed for each area using the unweighted combined posterior samples from a set of six sensitivity cases, plus the reference case (the "model-averaged" set), see the model scenarios section. 
For each performance measure, under each alternative 2021 catch level, vectors of 1,000 burned-in posterior samples from each of the seven models were combined into a single vector of 7,000 samples.
Probabilities of performance measures were then calculated from the combined samples [see @forrest2020].
...
-	$P(B_{2022} < B_{2021})$ ranged from 56% to 82% over the range of 2021 catch levels.
...
- $P(B_{2022} < USR)$ was 98% across all catch levels considered.
...
(below the USR) with 98% probability under all 2021 catch scenarios tested,
...
The model-averaged decision table probabilities are presented in Table \@ref(tab:tab-decision-avg-3cd).
In summary:

-	$P(B_{2022} < B_{2021})$ ranged from 22% to 90% over the range of 2021 catch levels.

- $P(F_{2021} > F_{2020})$ ranged from <1% to > 99%. The 2020 catch was extrapolated to be approximately 425 t, hence the probability increase between 400 t and 500 t.

- $P(B_{2022} < LRP)$ ranged from less than 1% to 1% over the range of catch levels.

- $P(B_{2022} < USR)$ ranged from 98% to 99%.

- $P(F_{2020} > LRR)$  ranged from <1% to 86%.
...
For provision of advice, results from seven alternative model configurations were used to generate decision tables.
...
1. The impact of uncertainty in the magnitude of pre-1996 discarding and foreign catches;
...
This document updates the current stock status of Pacific Cod stocks in Area 3CD and 5ABCD at the end of the 2020 fishing year, and provides 2021 catch advice in the form of decision tables.
