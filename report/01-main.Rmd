...
While there was no apparent decrease in survey or CPUE indices for either QCS or HS (Figure \@ref(fig:surv-canadian)), DFO Pacifc Science Branch has taken the opportunity to update all the data streams for both Areas 3CD and 5ABCD and re-run both stock assessments to re-assess stock status and provide catch advice.
...
There is also no evidence for genetic distinction between these two stocks [@forrest2013].
