...
Median biomass in 2021 relative to the LRP ranged from **XX to XX**.
Median biomass in 2021 relative to the USR ranged from **XX to XX**.
Median fishing mortality in 2020 relative to the LRR ranged from **XX to XX** (Table \@ref(tab:tab-ref-points-table-avg-5abcd)).
...
We note that this probability is based on the maximum LRR (i.e., average estimated fishing mortality rate from 1956--2004).
