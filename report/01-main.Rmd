...
A set of model scenarios was agreed upon at the Regional Peer Review (RPR) for model averaging in the 2018 assessment [@dfo2019].
The same set were used here (updated with catch data to 2020 and index data to 2019 where available).
...
Median biomass in 2021 relative to the LRP and USR is estimated to be 1.96 (1.40--3.11) and 0.39 (0.59--0.89), respectively.
...
It is recommended to survey this area as soon as it is feasible to do so, and updating this advice when the data are available.
