...
Median biomass in 2021 relative to the LRP ranged from **XX to XX**.
Median biomass in 2021 relative to the USR ranged from **XX to XX**.
Median fishing mortality in 2020 relative to the LRR ranged from **XX to XX** (Table \@ref(tab:tab-ref-points-table-avg-3cd)).
...
Median biomass in 2021 relative to the LRP and USR are estimated to be 1.640 (1.005--3.59) and 0.507 (0.313--0.962), respectively.
Median fishing mortality relative to the LRR is estimated to be 0.083 (0.038--0.137) (Table \@ref(tab:tab-ref-points-table-avg-5abcd)).
...
The probability of the stock exceeding the LRR is less than 1% for all levels of catch up to 400 t.
...
Such a harvest control rule has not been formally agreed upon for Pacific Cod and, therefore, the probabilities in Table \@ref(tab:summary-tab-decision-avg-3cd) and in previous Pacific Cod assessments [@dfo2015; @dfo2019], do not reflect any adjustment to the LRR when the stock is in the Cautious Zone.
