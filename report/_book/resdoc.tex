...
The model-averaged decision table for Area 3CD, based on a one year projection over a range of 2020 catch levels, suggests that under a 2020 catch of 500 tonnes (the current TAC), there is a 9\% probability that biomass in 2021 will be below the LRP (Table~\ref{tab:summary-tab-decision-avg-3cd}). However, assuming the 2020 catch is of a similar magnitude to the 2018 and 2019 catches (23 and 43 tonnes, respectively), the probability of the 2021 biomass being below the LRP is between 5\% and 6\% (Table~\ref{tab:summary-tab-decision-avg-3cd}).

Median estimated fishing mortality in 2019 was estimated to be 0.01 y\textsuperscript{-1}.
\begin{figure}[htb]
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-base-f-3cd-1}}{Figure \ref{fig:summary-fig-base-f-3cd}} 
...
\subsection{Area 5ABCD}\label{area-5abcd}}
\begin{figure}[htb]

{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-base-catch-fit-5abcd-1}}{Figure \ref{fig:summary-fig-base-catch-fit-5abcd}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-base-index-fits-5abcd-1}}{Figure \ref{fig:summary-fig-base-index-fits-5abcd}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-base-mean-weight-5abcd-1}}{Figure \ref{fig:summary-fig-base-mean-weight-5abcd}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-base-biomass-5abcd-1}}{Figure \ref{fig:summary-fig-base-biomass-5abcd}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-model-average-biomass-comp-5abcd-1}}{Figure \ref{fig:summary-fig-model-average-biomass-comp-5abcd}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-model-average-biomass-5abcd-1}}{Figure \ref{fig:summary-fig-model-average-biomass-5abcd}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-model-average-biomass-5abcd-proj-1}}{Figure \ref{fig:summary-fig-model-average-biomass-5abcd-proj}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{knitr-figs/summary-fig-base-f-5abcd-1}}{Figure \ref{fig:summary-fig-base-f-5abcd}} 
