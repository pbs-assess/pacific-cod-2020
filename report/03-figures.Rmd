...
```{r summary-fig-base-f-3cd, fig.cap="Posterior estimated fishing mortality for the Reference Model, Area 3CD."}
...
```{r fig-base-f-5abcd, fig.cap="Posterior estimated fishing mortality for the Reference Model, Area 5ABCD."}
