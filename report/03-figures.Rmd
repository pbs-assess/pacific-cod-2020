...
make.catches.plot.gear(catch.3.gear)
```
...
make.catches.plot.gear(catch.3.gear.recent)
```

```{r fig-catch-3cd-gear-vessel, fig.cap="Canadian catch for Area 3CD by gear. Catch includes at-sea releases."}
# This plot is for exploring, do not publish
# freezer <- c("NORTHERN ALLIANCE", "OSPREY NO 1", "VIKING ENTERPRISE", "RAW SPIRIT")
