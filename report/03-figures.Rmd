...
```{r fig-base-biomass-3cd, fig.cap="Posterior estimated biomass for Area 3CD. Green dashed line shows the median USR; red dashed line shows the median LRP."}
...
```{r fig-base-depl-3cd, fig.cap="Relative biomass for Area 3CD."}
b.plot(base.model.3cd,
       base.model.3cd.name,
       depl = TRUE)
```

```{r fig-base-recr-3cd, fig.cap="Recruitment (a) and recruitment deviations (b) for Area 3CD.  Green dashed line shows the mean of the MCMC posterior medians; blue dashed line shows the median of the MCMC posterior medians."}
...
```{r fig-base-f-3cd, fig.cap="Posterior estimated fishing mortality for Area 3CD."}
f.plot(base.model.3cd,
       base.model.3cd.name, french=french)
```
...
```{r fig-base-biomass-5abcd, fig.cap="Posterior estimated biomass for Area 5ABCD. Green dashed line shows the median USR; red dashed line shows the median LRP."}
...
```{r fig-base-depl-5abcd, fig.cap="Relative biomass for Area 5ABCD."}
b.plot(base.model.5abcd,
       base.model.5abcd.name,
       depl = TRUE, french=french)
```

```{r fig-base-recr-5abcd, fig.cap="Recruitment (a) and recruitment deviations (b) for Area 5ABCD. Green dashed line shows the mean of the MCMC posterior medians; blue dashed line shows the median of the MCMC posterior medians."}
...
```{r fig-base-f-5abcd, fig.cap="Posterior estimated fishing mortality for Area 5ABCD."}
f.plot(base.model.5abcd,
       base.model.5abcd.name, french=french)
```

-->

```{r fig-model-average-biomass-comp-3cd, fig.cap="Posterior estimates of biomass for the model-averaged set for Area 3CD. Green dashed line shows the median USR; red dashed line shows the median LRP."}
...
```{r fig-model-average-biomass-3cd, fig.cap="Combined posterior biomass for the model-averaged set for Area 3CD.  Green dashed line shows the median USR; red dashed line shows the median LRP."}
...
```{r fig-model-average-biomass-comp-5abcd, fig.cap="Posterior estimates of biomass for the model-averaged set for Area 5ABCD. Green dashed line shows the median USR; red dashed line shows the median LRP."}
...
```{r fig-model-average-f-comp-3cd, fig.cap="Posterior estimates of fishing mortality for the model-averaged set for Area 3CD. "}
f.plot(desc.models.3cd,
       desc.models.3cd.name,
       french=french)
```

```{r fig-model-average-f-3cd, fig.cap="Combined posterior fishing mortality for the model-averaged set for Area 3CD.  "}
f.plot(avg.model.3cd,
       base.model.3cd.name,
       french=french)
```

```{r fig-model-average-biomass-5abcd, fig.cap="Combined posterior biomass for the averaged models, Area 5ABCD. Green dashed line shows the median USR; red dashed line shows the median LRP."}
...
```{r fig-model-average-f-comp-5abcd, fig.cap="Posterior estimates of fishing mortality for the model-averaged set for Area 5ABCD. "}
f.plot(desc.models.5abcd,
       desc.models.5abcd.name,
       french=french)
```

```{r fig-model-average-f-5abcd, fig.cap="Combined posterior fishing mortality for the model-averaged set for Area 5ABCD.  "}
