...
```{r fig-model-average-f-comp-3cd, fig.cap="Posterior estimates of fishing mortality for the model-averaged set for Area 3CD. Thick solid lines show the posterior median and the shaded regions represent the 95\\% credible interval. Black dashed line shows the median LRR."}
...
```{r fig-model-average-f-comp-5abcd, fig.cap="Posterior estimates of fishing mortality for the model-averaged set for Area 5ABCD. Thick solid lines show the posterior median and the shaded regions represent the 95\\% credible interval. Black dashed line shows the median LRR."}
